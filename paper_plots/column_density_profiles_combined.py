...
def make_plots():
    ...
    fig.text(0.01, 0.5, r'log Si II column density [cm$^{-2}$]', fontsize=26, va='center', rotation='vertical')
    plotname = output_dir + 'SiII_radius_combined.png'
    plt.savefig(plotname)
    plotname = output_dir + 'SiII_radius_combined.pdf'
    plt.savefig(plotname)
    ...
    fig.text(0.95, 0.92, 'standard resolution', fontsize=24, ha='right')
    fig.text(0.95, 0.49, 'high resolution', fontsize=24, ha='right')
    fig.text(0.01, 0.5, r'log C IV column density [cm$^{-2}$]', fontsize=26, va='center', rotation='vertical')
    plotname = output_dir + 'CIV_radius_combined.png'
    plt.savefig(plotname)
    plotname = output_dir + 'CIV_radius_combined.pdf'
    plt.savefig(plotname)
    ...
    plt.savefig(plotname)
    plotname = output_dir + 'OVI_radius_combined.pdf'
    plt.savefig(plotname)
