...
def plot_cddf():
    ...
    axbot = fig.add_axes([0.1, 0.1, 0.88, 0.44],
                   ylim=(si2_limit-1.5,17.8), xlim=(13, 22))
    hb = axtop.hexbin(hi_colr, si2_colr,cmap='Oranges',extent=(13,22,si2_limit-1.5,18),mincnt=1,gridsize=200, vmin=0, vmax=1000)
    ...
    axtop.set_xticklabels(())
    hb = axbot.hexbin(hi_coln, si2_coln,cmap='Greens',extent=(13,22,si2_limit-1.5,18),mincnt=1,gridsize=200, vmin=0, vmax=999)
    ...
    axbot = fig.add_axes([0.1, 0.1, 0.88, 0.44],
                   ylim=(si4_limit-2.5, 17.8), xlim=(13, 22))
    hb = axtop.hexbin(hi_colr, si4_colr,cmap='Oranges',extent=(13,22,si4_limit-2.5,18),mincnt=1,gridsize=200, vmin=0, vmax=500)
    axtop.scatter(kodiaq['HI_col'], kodiaq['Si_IV_col'], color='k', marker='*', s=100, label='KODIAQ',zorder=100)
    cb = fig.colorbar(hb, ax=axtop)
    cb.set_label('counts, refined simulation')
    axtop.legend(loc='upper left')
    axtop.set_xticklabels(())
    hb = axbot.hexbin(hi_coln, si4_coln,cmap='Greens',extent=(13,22,si4_limit-2.5,18),mincnt=1,gridsize=200, vmin=0, vmax=500)
    ...
    axbot = fig.add_axes([0.1, 0.1, 0.88, 0.44],
                   ylim=(c4_limit-2.5,16), xlim=(13, 22))
    hb = axtop.hexbin(hi_colr, c4_colr,cmap='Oranges',extent=(13,22,c4_limit-2.5,16),mincnt=1,gridsize=200, vmin=0, vmax=2000)
    ...
    axtop.legend(loc='upper left')
    axtop.set_xticklabels(())
    hb = axbot.hexbin(hi_coln, c4_coln,cmap='Greens',extent=(13,22,c4_limit-2.5,16),mincnt=1,gridsize=200, vmin=0, vmax=2000)
