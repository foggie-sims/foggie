...
Enzo Parameters for FOGGIE Simulations 
======================================

This page lists the Enzo Parameters used for canonical FOGGIE runs 
and some other kinds of test runs. 
...
* `Cooling Refinement`_ 

* `H2 Regulated Star Formation`_ 

* `Star Formation and Feedback`_ 
...
Natural Runs
~~~~~~~~~~~~~~~~~~~~~~~~~
Stuff about natural runs 
   
.. _forced_refinement: 

Forced Refinement 
~~~~~~~~~~~~~~~~~~~~~~~~~
Stuff about forced refinement 

.. _cooling_refinement: 

Cooling Refinement 
~~~~~~~~~~~~~~~~~~
Stuff about cooling refinement 

.. _h2_regulated_star_formation: 

H2 Regulated Star Formation 
~~~~~~~~~~~~~~~~~~~~~~~~~~~

Enzo's H2-regulated star formation scheme is implemented in 
star_maker_h2reg.F 
The relevant parameters are: 

``H2StarMakerEfficiency``   
    Fraction of a cell mass turned into stars when that cell meets all SF
    criteria. Default = 0.01 

``H2StarMakerNumberDensityThreshold``  
    Minimum density, default = 0 

``H2StarMakerMinimumMass``             = 1000
    Minimum particle mass, default = 0 
...
``H2StarMakerWriteStarLogFiles``       = 1
    This parameter controls whether or not star_maker_h2reg.F  
    writes the diagnostic "starlog" files. Default = 0 
    If they are written, there will be one file for every 
    MPI process, and they will be long . . . 



.. _star_formation_and_feedback: 
...
``RadiativeCooling`` (external)
    ...
    possibilities, controlled by the value of another flag. See blah 
...
For details on each of the different star formation methods available in Enzo see
...
``StarFeedbackDistCellStep`` (external)
    ...
    * ``TopGridRank``.  Only implemented for ``StarParticleCreation`` method = 0
    or 1  with ``StarParticleFeedback`` method =  1.  
    Default: 0.
