...
def plot(fname, trackfile, ion_list=['O VI'], radius=500.):
    ...
    #replace with sphere 
    sph = ds.sphere(center=refine_box_center, radius=(500, 'kpc'))
    ad = sph 
    ...
    # all cells 
    export(create_image(df, *galaxy),"O6frac_Phase_All")
    export(create_image2(df, *galaxy),"O6frac_Proj_All")

    frame = df[df['frac'] == b'high']
    export(create_image(frame, *galaxy),"O6frac_Phase_High")
    export(create_image2(frame, *galaxy),"O6frac_Proj_High")

    frame = df[df['frac'] == b'med']
    export(create_image(frame, *galaxy),"O6frac_Phase_Med")
    export(create_image2(frame, *galaxy),"O6frac_Proj_Med")

    frame = df[df['frac'] == b'low']
    export(create_image(frame, *galaxy),"O6frac_Phase_Low")
    export(create_image2(frame, *galaxy),"O6frac_Proj_Low")
