...
if True:
	...
	axes[0].legend(loc='lower left', prop={'size': 5}, bbox_to_anchor= (0.0, 1.01), ncol=3, borderaxespad=0, frameon=False)
	axes[1].legend(loc='lower left', prop={'size': 5}, bbox_to_anchor= (0.0, 1.01), ncol=3, borderaxespad=0, frameon=False)
	axes[2].legend(loc='lower left', prop={'size': 5}, bbox_to_anchor= (0.0, 1.01), ncol=3, borderaxespad=0, frameon=False)

	fig.savefig('MetalDistributionFull.png')