...
for DD_ind, DD in enumerate(simulations):
	...
	if False:
		phaseplot = yt.PhasePlot(ob_sphere, "density", "temperature", "cell_mass", weight_field="cell_mass")
	...
	if True:
		...
		cen_sphere = ds.sphere(cen_cen, (cen_rad[DD_ind], "kpc"))
