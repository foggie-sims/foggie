...
##########
    extent = [x_left, x_right, y_right, y_left] ### LOOK I DON'T KNOW WHY IT'S THIS WAY
...
#                                        vmin=np.log10(temperature_min), vmax=np.log10(temperature_max))
        ...
        ax_spec0.plot(ray['x'][ray_sort], np.log10(ray['density'][ray_sort]), color='#984ea3',lw=1)
        ...
        ax_spec2.plot(ray['x'][ray_sort], np.log10(ray['metallicity'][ray_sort]), color='#984ea3',lw=1)
        plt.xlim(ray_min, ray_max)
        plt.ylim(-2.5,0.2)
