...
def make_misty_plots():
    ...
    sns.swarmplot(x="impact", y="Si_II_Nmin", data=ref_p, color='#984ea3',alpha=0.7,orient='h')
    # ax.scatter(nat['impact'], nat['Si_II_Nmin'], marker='D', color='#4daf4a',label='natural')
    # ax.scatter(ref['impact'], ref['Si_II_Nmin'], color='#984ea3', label='refined')
    ...
    #sns.swarmplot(x="Si_II_dv90", y="Si_II_Ncomp", data=ref_p, color='#984ea3',alpha=0.7,orient='h')
    ...
    ax.scatter(ref['Si_II_dv90'],ref['Si_II_Nmin'], color='#984ea3', marker='o',s=100, alpha=0.5,label='refined')
    ...
    ax.scatter(ref['Si_II_EW'],ref['Si_II_Nmin'], color='#984ea3', marker='o',s=100, label='refined')
    ...
    sns.swarmplot(x="Si_IV_col", y="Si_II_Nmin", data=ref_p, color='#984ea3',alpha=0.7,orient='h')
    ...
    ax.scatter(kodiaq['Si_IV_col'], kodiaq['Si_IV_Nmin'], color='k', marker='*', s=100, alpha=0.7, label='KODIAQ')
    ...
    sns.swarmplot(x="Si_II_col", y="Si_II_Ncomp", data=ref_p, color='#984ea3',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#984ea3', marker='o',s=100, alpha=0.5,label='refined')
    ax.scatter(kodiaq['Si_II_col'], kodiaq['Si_II_Ncomp'], color='k', marker='*', s=100, alpha=0.7, label='KODIAQ')
    plt.legend(loc='upper left', frameon=False)
    plt.xlim(xmin=10)
    plt.ylim(-0.5,14.5)
    ...
    sns.swarmplot(x="HI_col", y="Si_II_Nmin", data=ref_p, color='#984ea3',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#984ea3', marker='o',s=100, alpha=0.5,label='refined')
...
#    ax.scatter(ref['O_VI_Nmin'],ref['Si_II_Nmin'], color='#984ea3', marker='o',s=100, alpha=0.5,label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.hist(nat['Si_II_Nmin'], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['Si_II_Nmin'], color='#984ea3', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.hist(nat['Si_IV_Nmin'], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['Si_IV_Nmin'], color='#984ea3', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.hist(nat['C_IV_Nmin'], color='#4daf4a',bins=bins, normed=True, alpha=0.5, label='natural')
    ax.hist(ref['C_IV_Nmin'], color='#984ea3', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.hist(nat['O_VI_Nmin'], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['O_VI_Nmin'], color='#984ea3', bins=bins,normed=True, alpha=0.5,  label='refined')
