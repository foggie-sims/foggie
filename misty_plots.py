...
def make_misty_plots():
    ...
    sns.swarmplot(x="impact", y="Si_II_Nmin", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="impact", y="Si_II_Nmin", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    # ax.scatter(nat['impact'], nat['Si_II_Nmin'], marker='D', color='#4daf4a',label='natural')
    # ax.scatter(ref['impact'], ref['Si_II_Nmin'], color='#4575b4', label='refined')
    #ax.plot([10,45],[10,1],color='#4daf4a')
    #ax.plot([12,45],[17,4],color='#4575b4')
    ...
    ax.scatter(ref['impact'], ref['O_VI_Nmin'], color='#4575b4', label='refined')
    plt.legend(loc='upper right')
    plt.xlabel('impact parameter [kpc]')
    ...
    # ax.scatter(ref['Si_IV_col'], ref['C_IV_col'], color='#4575b4', label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="Si_II_dv90", y="Si_II_Ncomp", data=nat_si2, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="Si_II_dv90", y="Si_II_Ncomp", data=ref_si2, color='#4575b4',alpha=0.7,orient='h')
    ...
    #ax.scatter(nat['Si_II_dv90'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['Si_II_dv90'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="O_VI_dv90", y="O_VI_Nmin", data=nat_o6, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="O_VI_dv90", y="O_VI_Nmin", data=ref_o6, color='#4575b4',alpha=0.7,orient='h')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="Si_II_EW", y="Si_II_Ncomp", data=nat_si2, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="Si_II_EW", y="Si_II_Ncomp", data=ref_si2, color='#4575b4',alpha=0.7,orient='h')
    #ax.scatter(nat['Si_II_EW'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',label='natural')
    #ax.scatter(ref['Si_II_EW'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.scatter(nat['Si_IV_col'],nat['Si_IV_dv90'], marker='D', s=30, color='#4daf4a',alpha=0.5, label='natural')
    ax.scatter(ref['Si_IV_col'],ref['Si_IV_dv90'], color='#4575b4', marker='o',s=50, alpha=0.5, label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.scatter(nat['O_VI_col'],nat['O_VI_dv90'], marker='D', s=30, color='#4daf4a',alpha=0.5, label='natural')
    ax.scatter(ref['O_VI_col'],ref['O_VI_dv90'], color='#4575b4', marker='o',s=50, alpha=0.5, label='refined')
    ...
    ax.scatter(ref['HI_col'],ref['HI_1216_EW'], color='#4575b4', marker='o',s=100, alpha=0.5, label='refined')
    plt.legend(loc='upper left')
    #plt.xlim(xmin=0)
    plt.ylim(ymin=0)
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    ax.scatter(nat['O_VI_col'],nat['O_VI_EW'], marker='D', s=60, color='#4daf4a',alpha=0.5, label='natural')
    ax.scatter(ref['O_VI_col'],ref['O_VI_EW'], color='#4575b4', marker='o',s=100, alpha=0.5, label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="Si_IV_col", y="Si_IV_Nmin", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="Si_IV_col", y="Si_II_Nmin", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="HI_col", y="Si_II_Nmin", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="HI_col", y="Si_II_Nmin", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    ax.scatter(ref['HI_col'],ref['Si_IV_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    sns.stripplot(x=ref['O_VI_Nmin'], y=ref['Si_II_Nmin']-0.1,jitter=True, color='#4575b4', dodge=True,edgecolor='none',s=5, marker='o',alpha=0.5)
    # ax.scatter(nat['O_VI_Nmin'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
#    ax.scatter(ref['O_VI_Nmin'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    ax.scatter(ref['C_II_dv90'],ref['C_II_Ncomp'], color='#4575b4', marker='*',s=100, label='refined')
    plt.legend(loc='lower right')
    plt.xlim(xmin=0)
    plt.ylim(ymin=0)
    ...
    idr = [ref['Si_II_col'] > 12]
    idh = [hires['Si_II_col'] > 12]
    ax.hist(nat['Si_II_Nmin'][idn], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['Si_II_Nmin'][idr], color='#4575b4', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="Si_II_col", y="Si_II_Nmin", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="Si_II_col", y="Si_II_Nmin", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    ax.hist(nat['Si_IV_Nmin'][idn], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['Si_IV_Nmin'][idr], color='#4575b4', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    idn = [nat['C_IV_col'] > 12]
    idr = [ref['C_IV_col'] > 12]
    ax.hist(nat['C_IV_Nmin'][idn], color='#4daf4a',bins=bins, normed=True, alpha=0.5, label='natural')
    ax.hist(ref['C_IV_Nmin'][idr], color='#4575b4', bins=bins,normed=True, alpha=0.5,  label='refined')
    ...
    idn = [nat['O_VI_col'] > 13] ## 11.2
    idr = [ref['O_VI_col'] > 13]
    ax.hist(nat['O_VI_Nmin'][idn], color='#4daf4a', bins=bins,normed=True, alpha=0.5, label='natural')
    ax.hist(ref['O_VI_Nmin'][idr], color='#4575b4', bins=bins,normed=True, alpha=0.5,  label='refined')
