...
def make_misty_plots():
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    #sns.swarmplot(x="Si_II_dv90", y="Si_II_Ncomp", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    #sns.swarmplot(x="Si_II_dv90", y="Si_II_Ncomp", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    ...
    ax.scatter(kodiaq['Si_II_dv90'], kodiaq['Si_II_Nmin'], color='k', marker='*', s=100, alpha=0.5, label='KODIAQ')
    plt.legend(loc='lower right')
    plt.xlim(xmin=0)
    plt.ylim(ymin=0)
    ...
    #ax.scatter(kodiaq['Si_II_EW'], kodiaq['Si_II_Nmin'], color='k', marker='*', s=100, alpha=0.5, label='KODIAQ')
    plt.legend(loc='lower right')
    plt.xlim(xmin=0)
    plt.ylim(ymin=0)
    ...
    ax.scatter(ref['Si_IV_col'],ref['Si_IV_dv90'], color='#4575b4', marker='o',s=100, alpha=0.5, label='refined')
    ...
    fig = plt.figure(figsize=(9,7))
    ax = fig.add_subplot(111)
    sns.swarmplot(x="Si_II_col", y="Si_II_Ncomp", data=nat_p, color='#4daf4a',alpha=0.7,orient='h')
    sns.swarmplot(x="Si_II_col", y="Si_II_Ncomp", data=ref_p, color='#4575b4',alpha=0.7,orient='h')
    #ax.scatter(nat['HI_col'],nat['Si_II_Nmin'], marker='D', s=60, color='#4daf4a',alpha=0.5,label='natural')
    #ax.scatter(ref['HI_col'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ax.scatter(kodiaq['Si_II_col'], kodiaq['Si_II_Ncomp'], color='k', marker='*', s=100, alpha=0.7, label='KODIAQ',zorder=100)
    plt.legend(loc='upper left', frameon=False)
    plt.xlim(xmin=10)
    plt.ylim(1.5,14.5)
    ...
    fig.tight_layout()
    fig.savefig('SiII_col_vs_Ncomp.png')
...
#    ax.scatter(ref['O_VI_Nmin'],ref['Si_II_Nmin'], color='#4575b4', marker='o',s=100, alpha=0.5,label='refined')
    ...
    idn = [nat['O_VI_col'] > 11.2]
    idr = [ref['O_VI_col'] > 11.2]
