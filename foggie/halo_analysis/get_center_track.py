...
if __name__ == "__main__":
    ...
    args = parse_args()
    if args.halo == "4123":
        first_center = [0.4781351089477539, 0.4661512374877929, 0.47656536102294916]
        start_snap = 1400
        end_snap = 1600
    elif args.halo == "5036":
        first_center = [0.46848201751708984, 0.5018701553344727, 0.5013055801391602]
        start_snap = 2200
        end_snap = 2520
    elif args.halo == "2392":
        first_center = [0.4970941543579102, 0.48650646209716797, 0.46971225738525396]
        start_snap = 1260
        end_snap = 1400
    elif args.halo == "2878":
