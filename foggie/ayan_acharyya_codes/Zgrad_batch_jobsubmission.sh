...
python /nobackup/aachary2/ayan_codes/foggie/foggie/ayan_acharyya_codes/submit_jobs.py --call compute_Zscatter --prefix czs_10p_fb12 --halo 8508 --queue ldan --run feedback.12 --opt_args "--clobber --do_all_sims --upto_kpc 10 --res 0.1 --nbins 100 --weight mass --fit_multiple --write_file --use_gasre --foggie_dir /nobackup/jtumlins/ --forcepath"

# fdbk12 python: plot distribution 10 ckpc
python /nobackup/aachary2/ayan_codes/foggie/foggie/ayan_acharyya_codes/submit_jobs.py --call compute_Zscatter --prefix czs_10c_fb12 --halo 8508 --queue ldan --run feedback.12 --opt_args "--clobber --do_all_sims --upto_kpc 10 --docomoving --res 0.1 --nbins 100 --weight mass --fit_multiple --write_file --use_gasre --foggie_dir /nobackup/jtumlins/ --forcepath"
