...
def parse_args(haloname, RDname, fast=False):
    ...
    parser.add_argument('--center_guess', metavar='center_guess', type=str, action='store', default=None, help='initial guess for the center of desired halo in code units')
