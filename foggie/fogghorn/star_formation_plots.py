...
def young_stars_density_projection(ds, region, args, output_filename, projection):
    ...
    if '-disk' in projection:
        ...
        p = yt.ProjectionPlot(ds, p_dir, ('deposit', 'young_stars3_cic'), width=(args.proj_width, 'kpc'), center=ds.halo_center_code, north_vector=north_vector)
    else: p = yt.ProjectionPlot(ds, projection, ('deposit', 'young_stars3_cic'), width=(args.proj_width, 'kpc'), center=ds.halo_center_code)
