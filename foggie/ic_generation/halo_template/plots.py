...
ds = yt.load('/nobackup/jtumlins/CGM_bigbox/25Mpc_256_shielded-L0/RD0111/RD0111')

id_halo = 6953
index = [halos['ID'] == id_halo]
a = halos[index]

#plot position of this halo in the 256^3 gas run
...
dm = yt.load('/nobackup/jtumlins/CGM_bigbox/25Mpc_DM_256-L0/RD0111/RD0111')
...
center1 = [center0[0] - 118. / 255.,center0[1] - 77./255., center0[2] + 45./255.] # <------ L1 coords
