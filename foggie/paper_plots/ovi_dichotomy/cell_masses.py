...
df, image, ds = sm.simple_plot(dsname, trackfile, 'temperature', 'cell_mass', 'phase', ( (1,8), (-2,6) ), \
...
df, image, ds = sm.simple_plot(dsname, trackfile, 'temperature', 'cell_mass', 'phase', ( (1,8), (-2,6) ), \
                'RD0042_11n_10f_temperature_cell_mass_cgm_phase', region='cgm')

df, image, ds = sm.simple_plot(dsname, trackfile, 'temperature', 'cell_mass', 'phase', ( (1,8), (-2,6) ), \
                'RD0042_11n_10f_temperature_cell_mass_cgm_phase_fOVI', region='cgm', screenfield='O_p5_ion_fraction', screenrange=[0.1, 1.])
