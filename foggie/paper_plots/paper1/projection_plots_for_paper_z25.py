...
def plot_script(halo, foggie_dir, output_dir, run, axis, **kwargs):
    ...
    for snap in outs:
        ...
        box = ds.r[refine_box_center[0] - 0.5*width_code : refine_box_center[0] + 0.5*width_code, \
          refine_box_center[1] - 0.35*width_code : refine_box_center[1] + 0.05*width_code, \
          refine_box_center[2] - 0.55*width_code : refine_box_center[2] + 0.55*width_code]
        ...
        make_projection_plot(ds, prefix, "HI",  \
                        ...
                        width=width, appendix="_lefthand")
        make_projection_plot(ds, prefix, "SiII",  \
                        si2_min, si2_max, si2_color_map, \
                        ision=True, center=box.center, axis=axis, box=box, \
                        width=refine_width, appendix="_lefthand")
