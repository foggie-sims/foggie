...
python mod_vir_temp_paper_plots.py --halo 5036 --output DD2350 --plot energy_vs_radius --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Maelstrom
...
python mod_vir_temp_paper_plots.py --halo 5036 --output DD2350 --plot temperature_vs_radius --hist_from_file --filename stats_temperature_energy_velocity_pdf_sphere_mass-weighted_vcut-p5vff_dbl-gauss-fit_cgm-filtered --save_suffix Maelstrom
