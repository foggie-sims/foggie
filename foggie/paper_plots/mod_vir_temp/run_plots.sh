...
#python mod_vir_temp_paper_plots.py --halo 8508 --output DD2427 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Tempest_inner-r0p3Rvir --inner_r 0.3
#python mod_vir_temp_paper_plots.py --halo 5016 --output DD2360 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Squall_inner-r0p3Rvir --inner_r 0.3
#python mod_vir_temp_paper_plots.py --halo 5036 --output DD2510 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Maelstrom_inner-r0p3Rvir --inner_r 0.3

#python mod_vir_temp_paper_plots.py --halo 8508 --output DD2427 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Tempest_inner-r0p5Rvir --inner_r 0.5
#python mod_vir_temp_paper_plots.py --halo 5016 --output DD2360 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Squall_inner-r0p5Rvir --inner_r 0.5
#python mod_vir_temp_paper_plots.py --halo 5036 --output DD2510 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Maelstrom_inner-r0p5Rvir --inner_r 0.5

#python mod_vir_temp_paper_plots.py --halo 8508 --output DD2427 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Tempest_inner-r0p7Rvir --inner_r 0.7
#python mod_vir_temp_paper_plots.py --halo 5016 --output DD2360 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Squall_inner-r0p7Rvir --inner_r 0.7
#python mod_vir_temp_paper_plots.py --halo 5036 --output DD2510 --output_step 10 --plot energy_vs_radius_comp --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Maelstrom_inner-r0p7Rvir --inner_r 0.7
...
# Plot cooling time vs radius for 2nd/3rd referee reports
...
# Plot cooling energy losses over time for 3rd referee report
#python mod_vir_temp_paper_plots.py --halo 8508 --output DD0497-DD2427 --output_step 10 --plot cooling_energy_vs_time --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Tempest_cooling
#python mod_vir_temp_paper_plots.py --halo 5016 --output DD0590-DD2520 --output_step 10 --plot cooling_energy_vs_time --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Squall_cooling
#python mod_vir_temp_paper_plots.py --halo 5036 --output DD0590-DD2520 --output_step 10 --plot cooling_energy_vs_time --filename totals_mass_volume_energy_sphere_vcut-p5vff_cgm-filtered --save_suffix Maelstrom_cooling
