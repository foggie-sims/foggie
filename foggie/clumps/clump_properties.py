...
for boxi in ['box1','box2','box3','box4','box5','box6','box7','box8','box9','box10','box11','box12','box13','box14','box15','box16','box17','box18','box19','box20','box21','box22','box23','box24','box25','box26','box27']:
    ...
    col2 = fits.Column(name='clumpmasses', format='10E', unit='Msun', array=clumpmasses)
    col3 = fits.Column(name='clumpvolumes', format='10E', unit='kpc3', array=clumpvolumes)
    col4 = fits.Column(name='clumpradii', format='10E', unit='kpc', array=clumpradii)
    col5 = fits.Column(name='elongations', format='10E', unit='None', array=elongations)
    col6 = fits.Column(name='SiIImasses', format='10E', unit='Msun', array=SiIImasses)
    col7 = fits.Column(name='SiIIImasses', format='10E', unit='Msun', array=SiIIImasses)
    col8 = fits.Column(name='SiIVmasses', format='10E', unit='Msun', array=SiIVmasses)
    col9 = fits.Column(name='CIImasses', format='10E', unit='Msun', array=CIImasses)
    col10 = fits.Column(name='CIVmasses', format='10E', unit='Msun', array=CIVmasses)
    col11 = fits.Column(name='OVImasses', format='10E', unit='Msun', array=OVImasses)
    col12 = fits.Column(name='MgImasses', format='10E', unit='Msun', array=MgImasses)
    col13 = fits.Column(name='MgIImasses', format='10E', unit='Msun', array=MgIImasses)
    col14 = fits.Column(name='HImasses', format='10E', unit='Msun', array=HImasses)
    col15 = fits.Column(name='radialvelocities', format='10E', unit='km/s', array=radialvelocities)
    col16 = fits.Column(name='radialdistances', format='10E', unit='pc', array=radialdistances)
    col17 = fits.Column(name='com', format='10E', unit='code_units', array=com)
