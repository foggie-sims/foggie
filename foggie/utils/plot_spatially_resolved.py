...
"""
    ...
    Notes :      Plot spatially resolved scaling relations, profiles at a given resolution, for a given FOGGIE galaxy
    ...
    Examples :   run plot_spatially_resolved.py --system ayan_local --halo 8508 --output RD0030 --upto_kpc 10 --res 0.1 --plot_map --weight mass --docomoving --proj x --nbins 100 --fit_multiple --forproposal
                 run plot_spatially_resolved.py --system ayan_pleiades --halo 8508 --upto_kpc 10 --res 0.1 --do_all_sims --weight mass --use_gasre --plot_ks --plot_Z --plot_vel --plot_cm

"""
from header import *
from util import *
from foggie.gas_metallicity.compute_Zscatter import *
