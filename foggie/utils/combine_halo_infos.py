...
if __name__ == "__main__":
    ...
    big_table1.write(code_path + 'halo_infos/00' + args.halo + '/' + args.run + '/' + 'masses_z-gtr-2_test.hdf5', path='all_data', serialize_meta=True, overwrite=True)
    big_table2.write(code_path + 'halo_infos/00' + args.halo + '/' + args.run + '/' + 'masses_z-less-2_test.hdf5', path='all_data', serialize_meta=True, overwrite=True)
    ...
    big_table.write(code_path + 'halo_infos/00' + args.halo + '/' + args.run + '/' + 'satellites_test.hdf5', path='all_data', serialize_meta=True, overwrite=True)
    #################################################
